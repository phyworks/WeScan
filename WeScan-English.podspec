Pod::Spec.new do |spec|
  ...
  spec.homepage         = 'https://github.com/andreykrugliak/WeScan'
  spec.license          = { :type => 'MIT', :file => 'LICENSE' }
  spec.authors           = {
    'Boris Emorine' => 'boris@wetransfer.com',
    'Antoine van der Lee' => 'antoine@wetransfer.com'
  }
  spec.source           = { :git => 'https://github.com/andreykrugliak/WeScan.git', :tag => "#{spec.version}" }
